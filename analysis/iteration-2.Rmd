...
This plot shows the data overlaid with the functions $-sin(2 \pi x)$ (blue) and $-1.5 sin(\beta x)$ (red). The parameter 1.5 was "hand-adjusted". Obviously, this should be done with a simple fitting algorithm, but this is a bit awkward in R, so I did it in Python (see below).
